...
puts "EITA! É O DJ GBR"
dj_gbr = Artist.create(name: "DJ GBR")
dj_gbr.photo.attach(io: File.open("#{tmp_dir}/seed_files/djgbr.jpg"), filename: "djgbr.jpg")
 
pump_it = dj_gbr.albums.create(title: "Rave Pump it", date: Time.strptime("12/01/2020", "%d/%m/%Y"), category: funk)
pump_it.cover.attach(io: File.open("#{tmp_dir}/seed_files/pump_it.jpg"), filename: "pump_it.jpg")
 
rave_pump_it = pump_it.songs.create(title: "Rave Pump it - Toma Toma", played_count: Random.rand(1000))
rave_pump_it.file.attach(io: File.open("#{tmp_dir}/seed_files/musics/rave_pump_it.mp3"), filename: "rave_pump_it.mp3")
...
matheus = User.create(name: "Matheus", email: "matheus@email.com", password: "aaa123", password_confirmation: "aaa123")
matheus.favorites.create(favoritable: pump_it)
matheus.recently_heards.create(album: pump_it)
